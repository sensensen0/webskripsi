                                ...
                                while($data = mysqli_fetch_array($sql)){    
                                    ...
                                    ?>
                                        <tbody>
                                            ...
                                            <td>
                                             <img src="uploads/suratbaptis/<?php echo $lampirSuratBaptis;?>" style="width:200px;" alt="">
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <input id ="decline" type="button" class="btn btn-danger col-md-auto mb-1" value="Tolak" onclick="tolak(<?php echo "'$idDaftarPranikah'"; ?>)">
                                            </td>
                                        </tbody>
                                    <?php
                                }
  ...
  <script type="text/javascript">
    ...
    if( accept == "Terima") {
      if(confirm("Apakah anda yakin verifikasi data ini?")) {
          data.append("idDaftarPranikah", idDaftarPranikahSkrg);
    ...
    function tolak(idDaftarPranikah){
      ...
      if( decline == "Tolak") {
        if(confirm("Apakah anda yakin menolak verifikasi data ini?")) {
          ...
          data.append("idDaftarPranikah", idDaftarPranikah);
